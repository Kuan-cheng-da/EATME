#' @title Plot one-sided lower EWMA-p control chart
#'
#' @description Plot one-sided lower EWMA-p control chart  for input IC and OC data, the input need to be number of defectives.
#'
