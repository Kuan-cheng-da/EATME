#' @title The one-sided lower control limit for EWMA-p chart
#'
#' @description This function can calculate the one-sided lower control limit for EWMA-p chart, and adjusted EWMA-p chart.
